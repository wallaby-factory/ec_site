...
const COLORS = {
    fabric: [
        ...
        { name: 'ブラック', label: 'BLACK', hex: '#222222', img: '/assets/fabrics/mesh_black.jpeg' },
    ],
    cord: [
        ...
        { name: 'ブラック', label: 'BLACK', hex: '#222222', img: '/assets/cords/cord_black.jpg' },
    ],
    fastener: [
        ...
        { name: 'ブラック', label: 'BLACK', hex: '#222222', img: '/assets/stoppers/stopper_blackjpg.jpg' },
    ]
}
