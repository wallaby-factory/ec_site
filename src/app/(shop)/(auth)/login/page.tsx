...
// Sub-component to handle search params to avoid de-optimization of the entire page or hydration issues
function LoginForm() {
    ...
    return (
        <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-8">
            ...
            {isRegistered && (
                <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg text-green-800 text-sm font-bold text-center animate-pulse">
                    会員登録が完了しました。<br />
                    続けてログインしてください。
                </div>
            )}
